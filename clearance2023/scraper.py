...
class PricesaleScraper:
    ...
    def extract_data(self, item):
        ...
        return Product(img=img, url=url, brand=brand, name=name, sale_price=sale_price, normal_price=normal_price, discount_rate=discount_rate, discount_type='pricesale')
